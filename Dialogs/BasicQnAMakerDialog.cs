...
namespace Microsoft.Bot.Sample.QnABot
{
    ...
    public class BasicQnAMakerDialog : QnAMakerDialog
    {
        ...
        public BasicQnAMakerDialog() : base(new QnAMakerService(new QnAMakerAttribute(Utils.GetAppSetting("QnASubscriptionKey"), Utils.GetAppSetting("QnAKnowledgebaseId"), "I'm Sorry! I don't have an answer for you but I can help you create a ticket for this.", 0.5)))
        {}
    }
}